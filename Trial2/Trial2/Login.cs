...
namespace Trial2
{
    public partial class Login : MetroForm
    {
        ...
        public Login()
        {
            ...
            InitializeComponent();
            //Fill up CoatStyleCB [Right now just Allocators]
            string CoatString;
        ...
        {
            //Grab counts where user info is correct
            string CoatString;
        ...
        private void CoatSizeCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            catch (System.Exception ex) { MessageBox.Show("ErrorFromCOatSizeCBloops" + ex.Message); }

        }
        //handlers for my input boxes
        ...
        {
            {
                ...
                else
                {
                    ...
                    cmd.Parameters.AddWithValue("@Size", int.Parse(CoatSizeCB.Text));
                    ...
                    suggestCmd.Parameters.AddWithValue("@Size", int.Parse(CoatSizeCB.Text));
                    ...
                    //TrialDGV.DataSource = SuggestDS.Tables[0];
        ...
        private void TestValuesInsertBTN_Click(object sender, EventArgs e)
        {
            CoatStyleCB.Text = "Black Notch";
            CoatSizeCB.Text = "38";
            Radio3.Checked = true;
            Random rnd = new Random();
            int rndnumber = rnd.Next(0, 999999999);
            OrderIDTB.Text = rndnumber.ToString();
            StoreNumberCB.Text = "11";
            OrderTypeCB.Text = "W";
        }

        private void BigBoardBTN_Click(object sender, EventArgs e)
        {
            DGV4.Rows.Clear();
            DGV4.Refresh();
        ...
        {
            BackButton.Image = ((System.Drawing.Image)(Properties.Resources.BackArrow2));
        }

        private void BackButton_MouseLeave(object sender, EventArgs e)
        {
            BackButton.Image = ((System.Drawing.Image)(Properties.Resources.BackArrow1));
        }
    }
}
